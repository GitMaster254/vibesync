...
import { Plus, Play, Heart, Trash2, ArrowLeft } from 'lucide-react';
...
/**
 * Recently Added page - Shows tracks sorted by date added
 */
export default function RecentlyAdded() {
  ...
  const loadTracks = async () => {
    try {
      ...
      toast.error('Failed to load recently added tracks');
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="container mx-auto max-w-2xl px-4">
        ...
        {loading ? (
          ...
          >
            ...
            <p className="text-sm text-muted-foreground">Import music from the Library page</p>
          </motion.div>
        ) : (

...
// X is no longer needed here as the parent component handles closing
...
interface ListeningPartyProps {
  userId: string;
  username: string;
  // onClose prop is no longer strictly necessary if the parent controls the state
}

// **NOTE: The top-level div's full-screen styles have been removed**
export function ListeningParty({ userId, username }: ListeningPartyProps) {
  ...
  // The main card/modal, now focused on content and styling within the parent's boundaries
  return (
    <Card className="w-full p-6 bg-gray-900 shadow-2xl rounded-xl relative">
      ...
      {!roomId ? (
        ...
        <div className="space-y-6 text-white">
          {/* ... (rest of the content remains the same for member list, now playing, etc.) */}
